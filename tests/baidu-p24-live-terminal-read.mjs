...
try{
  ...
  console.log(JSON.stringify({ok:true,suite:"baidu-p24-live-terminal-read-recheck",status:"failed",failure_class_present:true,upstream_diagnostic_present:Boolean(b.upstream_diagnostic),network:true}));
