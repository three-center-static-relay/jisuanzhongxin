...
for(const f of ["built_land_cover","green_space","chain_brand_density","vacancy_risk"]){assert.equal(meta.features.includes(f),true)}
...
const args={
  source_receipts:[
    ...
    {source:"cmab_china",digest_sha256:"e".repeat(64)}
  ],
  units:[
    {id:"h3:8941b530807ffff",features:{population_market:88,working_age:72,poi_supply:75,poi_diversity:82,brand_presence:78,chain_brand_density:70,building_intensity:79,nonresidential_built:84,built_land_cover:86,green_space:35,night_activity:76,walk_accessibility:90,drive_accessibility:82,transit_accessibility:86,road_traffic:74,competition_pressure:70,hazard_risk:15,vacancy_risk:18}},
    {id:"h3:8941b53080fffff",features:{population_market:73,working_age:68,poi_supply:55,poi_diversity:64,brand_presence:52,building_intensity:61,built_land_cover:67,green_space:60,night_activity:58,walk_accessibility:70,drive_accessibility:75,transit_accessibility:62,competition_pressure:38,hazard_risk:12,vacancy_risk:28}}
  ]
};
...
console.log(JSON.stringify({ok:true,suite:"geospatial-commercial-domain",methods:meta.methods,reused_shared_models:meta.reused_shared_models,discovery_search_feature_sources:false,air_quality_in_commercial_core:false,network:false,observed_lbs:false}));
