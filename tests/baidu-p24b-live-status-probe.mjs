...
try{
  ...
  console.log(JSON.stringify({ok:true,suite:"baidu-p24b-live-status",state:"http-200-generic",json_parseable:(()=>{try{JSON.parse(text);return true}catch{return false}})(),network:true}));
