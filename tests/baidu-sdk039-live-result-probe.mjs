...
try{
  ...
  console.log(JSON.stringify({ok:true,suite:"baidu-sdk039-status-after-trigger",task_present:true,status:String(b.task.status||""),workflow_status:b.task.circleci_workflow_status||null,sdk_selftest_passed:b.task.sdk_selftest_passed===true,gpu:false,compute_credit_used:false}));
