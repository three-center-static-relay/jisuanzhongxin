...
// Status-only Baidu job-confirmation classifier. Never calls the P24c acceptance trigger.
...
try {
  ...
  assert.equal(body.task?.bridge_stage,"baidu_submitted");
  ...
  console.log(JSON.stringify({ok:true,suite:"diag-p24c-sdk039-baidu-job-confirmed",failure_class:body.task.failure_class,bridge_stage:body.task.bridge_stage,upstream_diagnostic:body.task.upstream_diagnostic||null}));
