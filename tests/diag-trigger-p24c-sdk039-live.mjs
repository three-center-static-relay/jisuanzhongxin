...
// Status-only exact bridge-stage classifier. Never calls the P24c acceptance trigger.
...
try {
  ...
  console.log(JSON.stringify({ok:true,suite:"diag-p24c-sdk039-exact-submit-returned",failure_class:body.task.failure_class,bridge_stage:body.task.bridge_stage,upstream_diagnostic:body.task.upstream_diagnostic||null}));
