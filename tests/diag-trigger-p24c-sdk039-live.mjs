...
// Status-only dispatch classifier. Never calls the P24c acceptance trigger.
...
try {
  ...
  console.log(JSON.stringify({ok:true,suite:"diag-p24c-sdk039-circleci-dispatched",circleci_pipeline_id_present:body.task.circleci_pipeline_id_present,failure_class:body.task.failure_class,bridge_stage:body.task.bridge_stage,upstream_diagnostic:body.task.upstream_diagnostic||null}));
