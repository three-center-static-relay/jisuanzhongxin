...
const TASK_ID="baidu-circleci-live-20260816p24a";
const PATH="/__acceptance/baidu-v100-p24-20260816-7d39c244a6b04f8b87e1b8ee2a2aa7f2";
const EXPIRES_AT=Date.parse("2026-08-16T11:30:00Z");
...
async function start(env){
  ...
  try{
    ...
    return json({ok:true,task_id:TASK_ID,status:"bridge_submitted",circleci_pipeline_id:out.pipeline_id,runtime:RUNTIME,device:"v100",gpus:1,payment:"coupon",one_shot:true,production_promoted:false},202);
  }catch(e){
