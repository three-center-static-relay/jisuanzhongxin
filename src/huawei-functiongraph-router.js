...
export async function maybeHandleHuaweiFunctionGraph(req,env){
  ...
  if(req.method==="GET"&&url.pathname==="/v1/providers/huawei-functiongraph/meta")return huaweiJson({ok:true,...huaweiFunctionGraphMeta(env),deployment_probe:"post-circuit-rollback-v1",live_probe_scope:"service-binding-internal-only"});
