...
function internalControl(req){return new URL(req.url).hostname==="compute.internal"}
function denyExternalControl(){return err("POLICY_DENIED","Baidu task status and cancel controls are service-binding internal only",403,{route_eligible:false})}
