import app,{CenterGate} from "./production-entry-baidu-p24-e2e.js";
...
const P24_ACCEPTANCE_PATH="/__acceptance/baidu-v100-p24-20260816-7d39c244a6b04f8b87e1b8ee2a2aa7f2";
const P24_TRIGGER_CRON="* * * * *";
...
export default{
  ...
  async scheduled(controller,env,ctx){
    if(String(controller?.cron||"")===P24_TRIGGER_CRON){ctx.waitUntil(app.fetch(new Request(`${ORIGIN}${P24_ACCEPTANCE_PATH}`,{method:"GET"}),env,ctx));return}
